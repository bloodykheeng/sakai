        ...
        <div className="grid p-fluid">
            ...
            <div className="col-12 md:col-6">
                <div className="card card-w-title">
                    ...
                    <Routes>
                        <Route path={"/menu"} element={<PersonalDemo />} />
                        <Route path={"/menu/confirmation"} element={<ConfirmationDemo />} />
                        <Route path={"/menu/payment"} element={<PaymentDemo />} />
                        <Route path={"/menu/seat"} element={<SeatDemo />} />
                    </Routes>
                </div>
            </div>
